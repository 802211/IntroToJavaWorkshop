...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor == -1) {
			...
			scare();
		} if(mouseColor == -1369846) JOptionPane.showMessageDialog(null, "You won.");
	...
	private void scare() {
		...
		// freesound.org. Log in as leagueofamazing/code4life.
		 AudioClip sound = JApplet.newAudioClip(getClass().getResource("spooky sounds.wav"));
		...
		// 9. drop an image into your day5 package, and use the showScaryImage method to scare your victim!
		 showScaryImage("scarypumpkin.jpg");
